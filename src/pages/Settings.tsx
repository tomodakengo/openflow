      ...
      <div className="bg-white rounded-lg shadow">
        <div className="md:flex">
          ...
          <div className="p-6 flex-1">
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="w-full md:w-1/2">
                      <label className="form-label" htmlFor="profile-language">Language</label>
                      <select
                        id="profile-language"
                        name="language"
            ...
            {activeTab === 'notifications' && (
              <div>
                ...
                <div className="space-y-6">
                        ...
                        <div className="relative inline-block w-10 mr-2 align-middle select-none">
                          ...
                          <label
                            ...
                            className={`toggle-label block overflow-hidden h-6 rounded-full cursor-pointer ${
                              notificationSettings.emailNotifications ? 'bg-primary-500' : 'bg-gray-300'
                            }`}
                          ></label>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="relative inline-block w-10 mr-2 align-middle select-none">
                          ...
                          <label
                            ...
                            className={`toggle-label block overflow-hidden h-6 rounded-full cursor-pointer ${
                              notificationSettings.pushNotifications ? 'bg-primary-500' : 'bg-gray-300'
                            }`}
                          ></label>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="relative inline-block w-10 mr-2 align-middle select-none">
                          ...
                          <label
                            ...
                            className={`toggle-label block overflow-hidden h-6 rounded-full cursor-pointer ${
                              notificationSettings.taskAssignments ? 'bg-primary-500' : 'bg-gray-300'
                            }`}
                          ></label>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="relative inline-block w-10 mr-2 align-middle select-none">
                          ...
                          <label
                            ...
                            className={`toggle-label block overflow-hidden h-6 rounded-full cursor-pointer ${
                              notificationSettings.taskComments ? 'bg-primary-500' : 'bg-gray-300'
                            }`}
                          ></label>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="relative inline-block w-10 mr-2 align-middle select-none">
                          ...
                          <label
                            ...
                            className={`toggle-label block overflow-hidden h-6 rounded-full cursor-pointer ${
                              notificationSettings.taskStatusChanges ? 'bg-primary-500' : 'bg-gray-300'
                            }`}
                          ></label>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="relative inline-block w-10 mr-2 align-middle select-none">
                          ...
                          <label
                            ...
                            className={`toggle-label block overflow-hidden h-6 rounded-full cursor-pointer ${
                              notificationSettings.workflowUpdates ? 'bg-primary-500' : 'bg-gray-300'
                            }`}
                          ></label>
                        </div>
                      </div>
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-medium text-gray-900 mb-3">Summary Reports</h3>
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="relative inline-block w-10 mr-2 align-middle select-none">
                          ...
                          <label
                            htmlFor="dailyDigest"
                            className={`toggle-label block overflow-hidden h-6 rounded-full cursor-pointer ${
                              notificationSettings.dailyDigest ? 'bg-primary-500' : 'bg-gray-300'
                            }`}
                          ></label>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="relative inline-block w-10 mr-2 align-middle select-none">
                          ...
                          <label
                            ...
                            className={`toggle-label block overflow-hidden h-6 rounded-full cursor-pointer ${
                              notificationSettings.weeklyDigest ? 'bg-primary-500' : 'bg-gray-300'
                            }`}
                          ></label>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="relative inline-block w-10 mr-2 align-middle select-none">
                          ...
                          <label
                            ...
                            className={`toggle-label block overflow-hidden h-6 rounded-full cursor-pointer ${
                              securitySettings.twoFactorEnabled ? 'bg-primary-500' : 'bg-gray-300'
                            }`}
                          ></label>
                        </div>
                      </div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="space-y-4">
                      <div>
                        <label className="form-label" htmlFor="app-theme">Application Theme</label>
                        <select
                          id="app-theme"
                          name="theme"
                          className="form-select"
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-medium text-gray-900 mb-3">Layout & Behavior</h3>
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <span className="font-medium">Compact View</span>
                          <p className="text-sm text-gray-500">Reduce white space to show more content</p>
                        </div>
                        <div className="relative inline-block w-10 mr-2 align-middle select-none">
                          <input
                            type="checkbox"
                          ...
                          <label
                            htmlFor="compactView"
                            className={`toggle-label block overflow-hidden h-6 rounded-full cursor-pointer ${
                              appearanceSettings.compactView ? 'bg-primary-500' : 'bg-gray-300'
                            }`}
                          ></label>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Display help text and tooltips</p>
                        </div>
                        <div className="relative inline-block w-10 mr-2 align-middle select-none">
                          <input
                            type="checkbox"
                          ...
                          <label
                            htmlFor="showGuides"
                            className={`toggle-label block overflow-hidden h-6 rounded-full cursor-pointer ${
                              appearanceSettings.showGuides ? 'bg-primary-500' : 'bg-gray-300'
                            }`}
                          ></label>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Use animations for transitions and effects</p>
                        </div>
                        <div className="relative inline-block w-10 mr-2 align-middle select-none">
                          <input
                            type="checkbox"
                          ...
                          <label
                            ...
                            className={`toggle-label block overflow-hidden h-6 rounded-full cursor-pointer ${
                              appearanceSettings.animationsEnabled ? 'bg-primary-500' : 'bg-gray-300'
                            }`}
                          ></label>
                        </div>
                      </div>
            ...
            {activeTab === 'data' && (
              <div>
                <h2 className="text-lg font-medium text-gray-900 mb-6">Data & Privacy Settings</h2>
                
                <div className="space-y-6">
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-medium text-gray-900 mb-3">Data Export</h3>
                    <p className="text-sm text-gray-600 mb-4">
                      Export all your data from the platform. This includes all workflows, forms, tasks, and account information.
                    </p>
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Configure how long we keep your data. Completed workflows and tasks can be automatically archived or deleted after a specified period.
                    </p>
                    <div className="space-y-4">
                      <div>
                        <label className="form-label" htmlFor="archive-completed">Archive completed workflows after</label>
                        <select
                      ...
                      <div>
                        <label className="form-label" htmlFor="delete-archived">Delete archived data after</label>
                        <select
                          id="delete-archived"
                          name="deleteArchived"
                          className="form-select"
                  ...
                  <div className="p-4 bg-error-50 rounded-lg border border-error-100">
                    <h3 className="font-medium text-error-900 mb-3">Danger Zone</h3>
