        ...
        <div className="flex-1 bg-white border rounded-lg p-6 overflow-auto">
          ...
          {form.fields.map((field, index) => (
            <div key={field.id} className="mb-6">
              <label 
                className={`block text-sm font-medium mb-2 ${field.required ? 'after:content-["*"] after:ml-0.5 after:text-error-500' : ''}`}
              >
                {field.label}
              </label>
                          ...
                          {(provided) => (
                            <div
                              ...
                              className={`mb-2 p-3 rounded-md border cursor-pointer hover:bg-gray-50
                                ${selectedFieldIndex === index ? 'border-primary-500 bg-primary-50' : 'border-gray-200'}
                              `}
            ...
            {selectedFieldIndex !== null && form.fields[selectedFieldIndex] ? (
              <div className="p-6">
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="form-control">
                      ...
                      <input 
                        ...
                        onChange={(e) => updateFieldProperty(selectedFieldIndex, 'name', e.target.value)}
                      />
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="form-control">
                      ...
                      <select 
                        ...
                        onChange={(e) => updateFieldProperty(selectedFieldIndex, 'type', e.target.value)}
                      >
                        {fieldTypes.map(type => (
                  ...
                  {['text', 'textarea', 'email', 'tel', 'number'].includes(form.fields[selectedFieldIndex].type) && (
                    <div className="form-control">
                      <label className="form-label">Placeholder</label>
                      <input 
                        type="text" 
                        className="form-input"
                        value={form.fields[selectedFieldIndex].placeholder || ''}
                        onChange={(e) => updateFieldProperty(selectedFieldIndex, 'placeholder', e.target.value)}
                      />
                    </div>
                  )}
                  
                  {['select', 'radio', 'checkbox'].includes(form.fields[selectedFieldIndex].type) && (
                    <div className="form-control">
                      <label className="form-label">Options</label>
                      <textarea 
                        className="form-textarea"
                        placeholder="Enter each option on a new line"
                        value={(form.fields[selectedFieldIndex].options || []).join('\n')}
                  ...
                  {['number'].includes(form.fields[selectedFieldIndex].type) && (
                    <div className="grid grid-cols-2 gap-4">
                      <div className="form-control">
                        ...
                        <input 
                          type="number" 
                          className="form-input"
                          value={form.fields[selectedFieldIndex].validation?.min || ''}
                          onChange={(e) => {
                            const validation = form.fields[selectedFieldIndex].validation || {};
                            updateFieldProperty(
                              selectedFieldIndex, 
                              'validation', 
                              { ...validation, min: e.target.value ? Number(e.target.value) : undefined }
                            );
                          }}
                        />
                      </div>
                      ...
                      <div className="form-control">
                        ...
                        <input 
                          type="number" 
                          className="form-input"
                          value={form.fields[selectedFieldIndex].validation?.max || ''}
                          onChange={(e) => {
                            const validation = form.fields[selectedFieldIndex].validation || {};
                            updateFieldProperty(
                              selectedFieldIndex, 
                              'validation', 
                              { ...validation, max: e.target.value ? Number(e.target.value) : undefined }
                            );
                          }}
                        />
                      </div>
              ...
              <div className="flex flex-col items-center justify-center h-full p-6 text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">Form Properties</h3>
                ...
                <div className="mt-8 text-gray-500">
                  {form.fields.length === 0 ? (
                    <p>Start by adding fields to your form from the panel on the left.</p>
                  ) : (
